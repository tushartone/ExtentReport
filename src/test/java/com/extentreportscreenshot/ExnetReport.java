...
public class ExnetReport {
	...
	public void setExtent(){
		...
		extent.addSystemInfo("Host Name", "Tushar");
		extent.addSystemInfo("User Name", "tushar");
	...
	public void tearDown(ITestResult result) throws IOException{
		...
		if(result.getStatus()==ITestResult.FAILURE){
			...
			String screenshotPath = ExnetReport.getScreenshot(driver, result.getName());
